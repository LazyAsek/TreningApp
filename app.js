...
const MondayWorkout = ["pompka","dimond push ups","wybuchowa","wolna pompka","pompka","diamentowo->normalna" ,"pompka z podnoszeniem ronk","smocza pompka","archer pushups","pompka"]

const TuesdayWorkout = ["podciaganie recznik","buterfly","2kg hantel","podciagani normalne","podciaganie daleko","podciaganie blisko","podciaganie neutralny","podchwyt klata do drazka","3kg hantel","ironmen","pompki opadajace","angel z butlami","4kg","wiszenie"]

const WednesdayWorkout = [ "brzuszki",  "wolne brzuszki", "siedzace brzuszki", "side boxing brzuszki", "podnoszenie kolan","podnoszenie nog", "rowerek", "norzyce","v hold","brzuszki kolanowe renka do kolana na bok","deska na boku na bok", "norzyce z podnoszeniem nog","pompka podnoszenie nog","wiszenie podnoszenie nog" ,"wiszenie podnoszenie nog"]
...
Workouts()
document.addEventListener("click",Workouts)
function Workouts(){
